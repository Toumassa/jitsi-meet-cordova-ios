...
MediaStream.create = function (dataFromEvent) {
	...
	execOrWait(onResultOK, null, 'iosrtcPlugin', 'MediaStream_setListener', [stream.id]);
...
MediaStream.prototype.addTrack = function (track) {
	...
	execOrWait(null, null, 'iosrtcPlugin', 'MediaStream_addTrack', [this.id, track.id]);
};
...
MediaStream.prototype.removeTrack = function (track) {
	...
	execOrWait(null, null, 'iosrtcPlugin', 'MediaStream_removeTrack', [this.id, track.id]);
...
function checkActive() {
	...
	function release() {
		...
		execOrWait(null, null, 'iosrtcPlugin', 'MediaStream_release', [self.id]);
	}
}
...
function MediaStreamRenderer(element) {
	...
	execOrWait(onResultOK, null, 'iosrtcPlugin', 'new_MediaStreamRenderer', [this.id]);
...
MediaStreamRenderer.prototype.render = function (stream) {
	...
	execOrWait(null, null, 'iosrtcPlugin', 'MediaStreamRenderer_render', [this.id, stream.id]);
	...
	stream.addEventListener('update', function () {
		...
		execOrWait(null, null, 'iosrtcPlugin', 'MediaStreamRenderer_mediaStreamChanged', [self.id]);
	});
	...
	function connected() {
		...
		if(self.element.onplaying != null)
		{
			self.element.onplaying();
		}
		
		/*if(self.element.canplay != null)
		{
			self.element.canplay();
		}
		else if(self.element.onplay != null)
		{
			self.element.onplay();
		}*/
	}
...
MediaStreamRenderer.prototype.refresh = function () {
	...
	function nativeRefresh() {
		...
		execOrWait(null, null, 'iosrtcPlugin', 'MediaStreamRenderer_refresh', [this.id, data]);
	}
};
...
MediaStreamRenderer.prototype.close = function () {
	...
	execOrWait(null, null, 'iosrtcPlugin', 'MediaStreamRenderer_close', [this.id]);
};
...
function MediaStreamTrack(dataFromEvent) {
	...
	execOrWait(onResultOK, null, 'iosrtcPlugin', 'MediaStreamTrack_setListener', [this.id]);
}
...
Object.defineProperty(MediaStreamTrack.prototype, 'enabled', {
	...
	set: function (value) {
		...
		this._enabled = !!value;
		execOrWait(null, null, 'iosrtcPlugin', 'MediaStreamTrack_setEnabled', [this.id, this._enabled]);
	}
});
...
MediaStreamTrack.prototype.stop = function () {
	...
	execOrWait(null, null, 'iosrtcPlugin', 'MediaStreamTrack_stop', [this.id]);
};
...
function RTCDataChannel(peerConnection, label, options, dataFromEvent) {
	...
	if (!dataFromEvent) {
		...
		execOrWait(onResultOK, null, 'iosrtcPlugin', 'RTCPeerConnection_createDataChannel', [this.peerConnection.pcId, this.dcId, label, options]);
	// Created via pc.ondatachannel.
		...
		execOrWait(onResultOK, null, 'iosrtcPlugin', 'RTCPeerConnection_RTCDataChannel_setListener', [this.peerConnection.pcId, this.dcId]);
	}
...
RTCDataChannel.prototype.send = function (data) {
	...
	if (typeof data === 'string' || data instanceof String) {
		execOrWait(onResultOK, null, 'iosrtcPlugin', 'RTCPeerConnection_RTCDataChannel_sendString', [this.peerConnection.pcId, this.dcId, data]);
	} else if (window.ArrayBuffer && data instanceof window.ArrayBuffer) {
		execOrWait(onResultOK, null, 'iosrtcPlugin', 'RTCPeerConnection_RTCDataChannel_sendBinary', [this.peerConnection.pcId, this.dcId, data]);
	} else if (
		...
		execOrWait(onResultOK, null, 'iosrtcPlugin', 'RTCPeerConnection_RTCDataChannel_sendBinary', [this.peerConnection.pcId, this.dcId, data.buffer]);
	} else {
...
RTCDataChannel.prototype.close = function () {
	...
	execOrWait(null, null, 'iosrtcPlugin', 'RTCPeerConnection_RTCDataChannel_close', [this.peerConnection.pcId, this.dcId]);
};
...
function RTCPeerConnection(pcConfig, pcConstraints) {
	...
	execOrWait(onResultOK, null, 'iosrtcPlugin', 'new_RTCPeerConnection', [this.pcId, this.pcConfig, pcConstraints]);
}
...
RTCPeerConnection.prototype.createOffer = function () {
	...
	if (isPromise) {
		return new Promise(function (resolve, reject) {
			...
			execOrWait(onResultOK, onResultError, 'iosrtcPlugin', 'RTCPeerConnection_createOffer', [self.pcId, options]);
		});
	}
	...
	execOrWait(onResultOK, onResultError, 'iosrtcPlugin', 'RTCPeerConnection_createOffer', [this.pcId, options]);
};
...
RTCPeerConnection.prototype.createAnswer = function () {
	...
	execOrWait(onResultOK, onResultError, 'iosrtcPlugin', 'RTCPeerConnection_createAnswer', [this.pcId, options]);
};
...
RTCPeerConnection.prototype.setLocalDescription = function (desc) {
	...
	if (isPromise) {
		return new Promise(function (resolve, reject) {
			...
			execOrWait(onResultOK, onResultError, 'iosrtcPlugin', 'RTCPeerConnection_setLocalDescription', [self.pcId, desc]);
		});
	}
...
RTCPeerConnection.prototype.setRemoteDescription = function (desc) {
	...
	if (isPromise) {
		return new Promise(function (resolve, reject) {
			...
			execOrWait(onResultOK, onResultError, 'iosrtcPlugin', 'RTCPeerConnection_setRemoteDescription', [self.pcId, desc]);
		});
	}
...
RTCPeerConnection.prototype.addIceCandidate = function (candidate) {
	...
	if (isPromise) {
		return new Promise(function (resolve, reject) {
			...
			execOrWait(onResultOK, onResultError, 'iosrtcPlugin', 'RTCPeerConnection_addIceCandidate', [self.pcId, candidate]);
		});
	}
	...
	execOrWait(onResultOK, onResultError, 'iosrtcPlugin', 'RTCPeerConnection_addIceCandidate', [this.pcId, candidate]);
};
...
RTCPeerConnection.prototype.addStream = function (stream) {
	...
	execOrWait(null, null, 'iosrtcPlugin', 'RTCPeerConnection_addStream', [this.pcId, stream.id]);
};
...
RTCPeerConnection.prototype.removeStream = function (stream) {
	...
	execOrWait(null, null, 'iosrtcPlugin', 'RTCPeerConnection_removeStream', [this.pcId, stream.id]);
};
...
RTCPeerConnection.prototype.close = function () {
	...
	execOrWait(null, null, 'iosrtcPlugin', 'RTCPeerConnection_close', [this.pcId]);
};
...
function enumerateDevices() {
	...
	if (isPromise) {
		return new Promise(function (resolve) {
			...
			execOrWait(onResultOK, null, 'iosrtcPlugin', 'enumerateDevices', []);
		});
	}
...
function getUserMedia(constraints) {
	...
	if (isPromise) {
		return new Promise(function (resolve, reject) {
			...
			execOrWait(onResultOK, onResultError, 'iosrtcPlugin', 'getUserMedia', [newConstraints]);
		});
	}
...
function selectAudioOutput(output) {
	...
	switch (output) {
		case 'earpiece':
			execOrWait(null, null, 'iosrtcPlugin', 'selectAudioOutputEarpiece', []);
			break;
		case 'speaker':
			execOrWait(null, null, 'iosrtcPlugin', 'selectAudioOutputSpeaker', []);
			break;
		default:
...
function dump() {
	execOrWait(null, null, 'iosrtcPlugin', 'dump', []);
}
 ...
 */
	...
	domObserver = new MutationObserver(function (mutations) {
		...
		function checkVideoConcerned(node) {
			var j, childNode;
			...
			if (node.nodeName === 'VIDEO') {
				...
				for (j = 0; j < node.childNodes.length; j++) {
					...
					return false || checkNewNode(childNode);
				}
				return false;
			}
		}
